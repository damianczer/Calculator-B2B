...
export const GUIDE_STYLES = {
    ...
    header: 'px-6 lg:px-8 py-8 border-b border-x border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex-shrink-0',
    headerTitle: 'text-4xl font-bold text-slate-900 dark:text-slate-100 mb-3',
    headerSubtitle: 'text-xl text-slate-600 dark:text-slate-400',
    ...
    mainContent: 'flex-1 overflow-y-auto p-6 lg:p-8',
    section: 'bg-white dark:bg-slate-900 rounded-lg shadow-sm p-6 lg:p-8 border border-slate-200 dark:border-slate-800 mb-6',
