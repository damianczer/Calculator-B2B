...
export const HEADER_CLASSES = 'sticky top-0 z-50 w-full border-b border-blue-300/50 dark:border-blue-800/50 bg-gradient-to-r from-blue-400 to-blue-500 dark:from-blue-700 dark:to-blue-800 backdrop-blur transition-colors';
...
export const GUIDE_STYLES = {
    ...
    header: 'px-6 lg:px-8 py-8 border-b border-x border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex-shrink-0 text-center lg:text-left',
    headerTitle: 'text-2xl sm:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-3',
    headerSubtitle: 'text-base sm:text-xl text-slate-600 dark:text-slate-400',
    ...
    sectionSubtitle: 'text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3',
    infoBox: 'p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-800',
    ...
    gridTwo: 'grid grid-cols-2 gap-4 mb-6',
    gridThree: 'grid grid-cols-3 gap-4 mb-6',
